...
export const TESTIMONIALS = [
  {
    quote:
      "Boht badia bhai ek dum sahi disha mein ja raha hai tu! Esehi aage badhta reh success jhak marke tere pechhe padegi!",
    name: "Rancho",
    image: "/rancho.jpg",
    role: "Scientist",
  },
  {
    quote:
      "Janha pana tussi great ho! It is now easy for me to split the money in a group.",
    name: "Raju Rastogi",
    image: "/raju-rastogi.webp",
    role: "Mechanical Engineer",
  },
  {
    quote:
      "Masst Website banayi bhai! Abb raju se time pe apne paise lunga",
    name: "Farhan Qureshi",
    image: "/farhan.jpeg",
    role: "Profesional Photographer",
  },
];
